...
const String defaultUrl = "https://vps.isi-net.org/api/petengoran/list/1?timer=hour&data=";
...
class _HistoricalPetengoranState extends State<HistoricalPagePetengoran>
  ...
  List<DropdownMenuItem<String>> get dropdownItems{
    List<DropdownMenuItem<String>> menuItems = [
      DropdownMenuItem(child: Text("1 Hour"),value: 'https://vps.isi-net.org/api/petengoran/list/1?timer=hour&data='),
      DropdownMenuItem(child: Text("12 Hour"),value: "https://vps.isi-net.org/api/petengoran/list/12?timer=hour&data="),
      DropdownMenuItem(child: Text("24 Hours"),value: "https://vps.isi-net.org/api/petengoran/list/24?timer=hour&data="),
      DropdownMenuItem(child: Text("3 Days"),value: "https://vps.isi-net.org/api/petengoran/list/3?timer=day&data="),
      DropdownMenuItem(child: Text("7 Days"),value: "https://vps.isi-net.org/api/petengoran/list/7?timer=day&data="),
      DropdownMenuItem(child: Text("30 Days"),value: "https://vps.isi-net.org/api/petengoran/list/30?timer=day&data="),
    ];
    return menuItems;
  }
